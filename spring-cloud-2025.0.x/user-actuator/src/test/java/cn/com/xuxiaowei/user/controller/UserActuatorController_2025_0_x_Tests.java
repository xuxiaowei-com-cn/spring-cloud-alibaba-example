...
class UserActuatorController_2025_0_x_Tests {
	...
	void gatewayProperties() {
		String url = "http://localhost:5021/user-actuator/properties";
		Map<?, ?> map = REST_TEMPLATE.getForObject(url, Map.class);
		log.info(String.valueOf(map));
	...
	void gatewayMvcProperties() {
		String url = "http://localhost:5022/user-actuator/properties";
		Map<?, ?> map = REST_TEMPLATE.getForObject(url, Map.class);
		log.info(String.valueOf(map));
