...
public class SpringJob {
	 ...
	 */
	@Scheduled(cron = "0 */5 * * * ?")
	@SchedulerLock(name = "SpringJob.2025.1.x.job1", lockAtMostFor = "2m", lockAtLeastFor = "1m")
	public void job1() {
	...
	@SchedulerLock(name = "SpringJob.2025.1.x.job2", lockAtMostFor = "4s", lockAtLeastFor = "4s")
	public void job2() {
	...
	@SchedulerLock(name = "SpringJob.2025.1.x.job3", lockAtMostFor = "4s", lockAtLeastFor = "4s")
